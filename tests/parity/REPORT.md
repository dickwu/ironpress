...
<!-- parity-invocation-id: 58a168c38aaec6dbf04251d063a8028f -->

<!-- parity-report-json-sha256: a13370ab8f1186d30af9dc503b13701af10f1e6f53e1e7ca4fb71dac3c027dd0 -->

| health | verified visual parity | exact raster | visual-policy | FAIL | disputed refs | total |
|:------:|-----------------------:|-------------:|--------------:|-----:|--------------:|------:|
| **BROKEN** | 98.56% | 825 | 753 | 23 | 10 | 1611 |

**Needs attention: 23 failing fixture(s) · 10 disputed reference(s) · 1 integrity item(s).** PASS rule: a fixed, same-coordinate human-visibility policy is applied after both PDFs use the same pdftoppm executable and arguments. It never translates, registers, or fixture-tunes either image. Every raw RGBA difference remains reported.

Scope: 509 category/feature pairs · labels only: implemented 1574 · partial 37 · unsupported 0 · supported-family interactions 300/300 across 24 families.

**Raster audit: 825 exact PASSes · 753 visual-policy PASSes (max raw difference 69.93%; CSS-scale observation: balanced edge coverage 12 · CSS-scale observation: conserved sub-CSS coverage 28 · CSS-scale observation: one-sided sub-CSS outline coverage 31 · CSS-scale observation: predominant shared-outline coverage 15 · CSS-scale observation: stable same-coordinate outline phase 76 · CSS-scale observation: sub-CSS shared-colour coverage 253 · CSS-scale observation: sub-CSS shared-outline coverage 200 · raw policy 138).** Each visual-policy fixture card keeps its raw difference and policy basis.
...
**REGRESSION — FAILED.** parity integrity gate FAILED (23 issue(s)):
...
|-----------------|---------:|----------------|
| direct paint mismatch | 8 | Missing/Extra paint is the policy-triggering defect; inspect first |
| colour-only residual | 15 | colour/coverage is the policy-triggering defect; review at authored scale |
...
| FAIL | interactions | [`interactions-cartesian-paged-media-x-transforms`](cases/interactions/interactions-cartesian-paged-media-x-transforms.html) | supported-family-cartesian-product · direct paint mismatch · Missing · max-page pixel diff 1.02% · 3835 differing RGBA pixels · page 4: candidate lacks paint present in reference (3.8%) |
...
| FAIL | interactions | [`interactions-cartesian-fonts-advanced-x-text-advanced`](cases/interactions/interactions-cartesian-fonts-advanced-x-text-advanced.html) | supported-family-cartesian-product · direct paint mismatch · Missing · max-page pixel diff 0.75% · 7644 differing RGBA pixels · candidate lacks paint present in reference (0.2%) |
...
| FAIL | interactions | [`interactions-cartesian-effects-x-paged-media`](cases/interactions/interactions-cartesian-effects-x-paged-media.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 1.97% · 7376 differing RGBA pixels · page 2: fill recolour ΔRGB(-8,+36,+19) (ΔE 33.3) |
...
| FAIL | interactions | [`interactions-cartesian-multicol-x-tables`](cases/interactions/interactions-cartesian-multicol-x-tables.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 1.11% · 11241 differing RGBA pixels · fill recolour ΔRGB(+144,+128,+111) (ΔE 43.4) |
| FAIL | interactions | [`interactions-cartesian-grid-x-multicol`](cases/interactions/interactions-cartesian-grid-x-multicol.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 0.91% · 9198 differing RGBA pixels · fill recolour ΔRGB(+144,+128,+111) (ΔE 43.8) |
| FAIL | interactions | [`interactions-cartesian-flexbox-x-multicol`](cases/interactions/interactions-cartesian-flexbox-x-multicol.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 0.79% · 8044 differing RGBA pixels · fill recolour ΔRGB(-95,-89,-81) (ΔE 46.2) |
| FAIL | interactions | [`interactions-cartesian-fonts-advanced-x-images-replaced`](cases/interactions/interactions-cartesian-fonts-advanced-x-images-replaced.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 0.69% · 7029 differing RGBA pixels · fill recolour ΔRGB(+9,+4,+3) (ΔE 16.5) |
...
| FAIL | interactions | [`interactions-cartesian-effects-x-fonts-advanced`](cases/interactions/interactions-cartesian-effects-x-fonts-advanced.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 0.57% · 5832 differing RGBA pixels · fill recolour ΔRGB(+9,-8,-7) (ΔE 33.2) |
...
| FAIL | interactions | [`interactions-cartesian-fonts-advanced-x-typography`](cases/interactions/interactions-cartesian-fonts-advanced-x-typography.html) | supported-family-cartesian-product · colour-only residual · ColorValue · max-page pixel diff 0.53% · 5410 differing RGBA pixels · fill recolour ΔRGB(+4,+4,+3) (ΔE 40.5) |
...
|----------|-----------------------:|-----:|-----:|--------------:|
| [interactions](cases/interactions/) | 93.62% | 308 | 21 | 0 |
...
| [images-replaced](cases/images-replaced/) | 100.00% | 37 | 0 | 0 |
