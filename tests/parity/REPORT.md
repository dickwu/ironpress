...
<!-- parity-invocation-id: 29029248f41115765c68921d197f8e29 -->

<!-- parity-report-json-sha256: 546d7f9350ccc901228de34c6b0a9b834a712931d449bcd1bd1e18aed5530028 -->

| health | verified visual parity | exact raster | visual-policy | FAIL | disputed refs | total |
|:------:|-----------------------:|-------------:|--------------:|-----:|--------------:|------:|
| **BROKEN** | 99.13% | 826 | 762 | 14 | 10 | 1612 |

**Needs attention: 14 failing fixture(s) · 10 disputed reference(s) · 1 integrity item(s).** PASS rule: a fixed, same-coordinate human-visibility policy is applied after both PDFs use the same pdftoppm executable and arguments. It never translates, registers, or fixture-tunes either image. Every raw RGBA difference remains reported.
...
**Raster audit: 826 exact PASSes · 762 visual-policy PASSes (max raw difference 69.93%; CSS-scale observation: balanced edge coverage 1 · CSS-scale observation: conserved sub-CSS coverage 28 · CSS-scale observation: one-sided sub-CSS outline coverage 32 · CSS-scale observation: predominant shared-outline coverage 14 · CSS-scale observation: stable same-coordinate outline phase 77 · CSS-scale observation: sub-CSS shared-colour coverage 268 · CSS-scale observation: sub-CSS shared-outline coverage 201 · raw policy 141).** Each visual-policy fixture card keeps its raw difference and policy basis.
...
**REGRESSION — FAILED.** parity integrity gate FAILED (14 issue(s)):
...
|-----------------|---------:|----------------|
| direct paint mismatch | 5 | Missing/Extra paint is the policy-triggering defect; inspect first |
...
|----------|-----------------------:|-----:|-----:|--------------:|
| [interactions](cases/interactions/) | 96.35% | 317 | 12 | 0 |
